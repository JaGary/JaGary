...
CREATE TABLE `cart_goods` (
  ...
  `urlimg` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `pricecart` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
